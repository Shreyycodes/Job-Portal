    ...
    <div className="bg-white text-black rounded-lg w-full">
        <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
            <div className="flex flex-col md:flex-row items-center ">
                ...
                <div className="text-center md:text-left text-neutral-700">
                    <h1 className="text-2xl sm:text-[40px] font-semibold">{jobData.title}</h1>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:max-w-[785px]">
                <h2 className="text-[24px] font-semibold mb-6 text-[#252525]">Job description</h2>
                <div className="rich-text" dangerouslySetInnerHTML={{__html:jobData.description}}></div>
                <button onClick={applyHandler} className="bg-blue-600 px-10 p-2.5 text-white rounded mt-14">{isAlreadyApplied ? 'Already Applied' : 'Apply Now'}</button>
            </div>
