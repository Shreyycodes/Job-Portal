                ...
                <tbody>
                    {viewApplicationsPageData.map((applicant, index) => (
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='px-4 py-2 border-b text-center max-sm:hidden'>{applicant.jobTitle}</td>
                            <td className='px-4 py-2 border-b text-center max-sm:hidden'>{applicant.location}</td>
